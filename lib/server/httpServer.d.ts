 ...
 */
export declare function runRoute(request: WorkingRequest, routeSpec: RouteSpec): Promise<any>;
/**
 ...
 */
export declare function bunRequestToWorkingRequest(request: BunRequest): WorkingRequest;
